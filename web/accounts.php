...
$session = [
  ...
  "categoryOptions" => array_map(function($category_id) use ($db_categories_by_sort){
      return [
        "label" => category_name($db_categories_by_sort, $category_id),
...
<head>
    ...
    <script type="text/javascript">
        require.config({"urlArgs":"","baseUrl":"/Client","waitSeconds":20,"paths":{"config":"/config.5326342110","oldScripts":"/Content/Scripts"}});
