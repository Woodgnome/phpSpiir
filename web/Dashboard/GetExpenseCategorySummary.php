...
$config = [
  ...
  "sort_type" => "abs",
  "categories" => [ "Expense", null ],
  "category_id" => !empty($_REQUEST["categoryId"]) ? $_REQUEST["categoryId"] : null,
];
...
$db_categories = !empty($_REQUEST["categoryId"]) ? get_categories($_REQUEST["categoryId"]) : get_categories("Expense");
  ...
  $result = [
    "summary" => [
      ...
      "averageMonth" => [
        ...
        "total" => -0.01 / $number_of_months * array_sum(array_map(function($month){ return $month["Expense"]["Total"]; }, $months_over)),
        "month" => null,
    ...
    "comparisonCategories" => array_values(array_map(
      function($db_category){
        return [
          "rowKey" => $db_category["category_id"],
