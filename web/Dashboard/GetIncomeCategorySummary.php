...
$db_categories = get_categories("Income");
...
$result = [
  "summary" => [
    ...
    "averageMonth" => [
      ...
      "total" => 0.01 / $number_of_months * array_sum(array_map(function($month){ return $month["Income"]["Total"]; }, $months_over)),
      "month" => null,
