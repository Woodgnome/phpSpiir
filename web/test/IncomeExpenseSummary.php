...
$entries = [
  "12 months" => [
    "json_path" => __DIR__ . "/../../archive/IncomeExpenseSummary_12month.json",
    "query" => "_t=1777147443644",
  ],
  "2026" => [
    "json_path" => __DIR__ . "/../../archive/IncomeExpenseSummary_2026.json",
    "query" => "_t=1777147472772&startMonth=202601&endMonth=202612",
  ],
  "2025" => [
    "json_path" => __DIR__ . "/../../archive/IncomeExpenseSummary_2025.json",
    "query" => "_t=1777147513177&startMonth=202501&endMonth=202512",
  ],
  "2024" => [
    "json_path" => __DIR__ . "/../../archive/IncomeExpenseSummary_2024.json",
    "query" => "_t=1777148841385&startMonth=202401&endMonth=202412",
  ],
  "2023" => [
    "json_path" => __DIR__ . "/../../archive/IncomeExpenseSummary_2023.json",
    "query" => "_t=1777148906314&startMonth=202301&endMonth=202312",
  ],
  "2022" => [
    "json_path" => __DIR__ . "/../../archive/IncomeExpenseSummary_2022.json",
    "query" => "_t=1777148924866&startMonth=202201&endMonth=202212",
  ],
  "2021" => [
    "json_path" => __DIR__ . "/../../archive/IncomeExpenseSummary_2021.json",
    "query" => "_t=1777147616588&startMonth=202101&endMonth=202112",
  ],
  "2020" => [
    "json_path" => __DIR__ . "/../../archive/IncomeExpenseSummary_2020.json",
    "query" => "_t=1777147607221&startMonth=202001&endMonth=202012",
  ],
  "2019" => [
    "json_path" => __DIR__ . "/../../archive/IncomeExpenseSummary_2019.json",
...
foreach ($entries as $key => $entry){
  ...
  $b = json_decode(get_my_spiir_url($_ENV["SCHEME"] . "://" . $_ENV["HOST"] . "/Dashboard/GetIncomeExpenseSummary.php?" . $entry["query"]), true);
  ...
  try {
    ...
    echo $_ENV["SCHEME"] . "://" . $_ENV["HOST"] . "/Dashboard/GetIncomeExpenseSummary.php?" . $entry["query"] . "\n\n";
    echo "Theirs <--> Mine\n";
    echo $message. "\n\n";
