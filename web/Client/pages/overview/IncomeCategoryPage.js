define(function(require) {
    ...
    var template = require('template!IncomeCategoryPage');
    ...
    var ExtraordinaryPostingsTooltip = require('components/extraordinary/ExtraordinaryPostingsTooltip');
        ...
        return core.StatePage.extend({
            ...
            routes: [
                { id: 'category-income', url: '', action: 'showIncome' }
            ],

            constructor: function () {
                this.subNavigation = overviewUtilities.getSubNavigation('category-income');
            ...
            updateUI: function() {
                ...
                return overviewService.getIncomeCategorySummary(startMonth, endMonth)
                    .then(function(result) {
                        ...
                        me.extraordinaryAmount(result.summary.extraordinaryIncome);
